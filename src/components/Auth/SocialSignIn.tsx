    ...
    <>
      <div className="flex gap-4">
        ...
        <button
          ...
          className="flex w-full items-center justify-center gap-2.5 rounded-lg p-3.5 text-white bg-gradient-to-r from-primary/60 to-secondary/60 hover:from-primary hover:to-secondary hover:bg-slateGray"
        >
          Sign In
          <svg
            width="22"
